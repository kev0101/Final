...
<aside id="sidebar">
	...
	<?php if (isset($_SESSION['usuario'])) : ?>
		<div id="usuario-logueado" class="bloque">
			...
			<a href="crear-categoria.php" class=" boton color_boton">Crear categoria</a>
			<a href="mis-datos-Admin.php" class=" boton color_boton">Mis datos</a>
			<a href="indexAdmin.php" class=" boton color_boton">Atras</a>
